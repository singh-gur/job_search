...
class Experience(BaseModel):
    ...
    projects: List[Project] = Field(default_factory=list, description="List of projects worked on")
...
class JobSearchParams(BaseModel):
    ...
    search_term: str = Field(default="Software Developer", description="Job title or search term")
    location: str = Field(default="Remote", description="Job location")
    results_wanted: int = Field(default=10, ge=1, le=100, description="Number of job results to retrieve")
...
class JobSearchConfig(BaseModel):
    ...
    job_search_params: JobSearchParams = Field(default_factory=JobSearchParams)
