...
class JobSearchFlow(Flow[JobSearchState]):
    ...
    def search_and_analyze_jobs(self):
        ...
        crew_inputs = {
            ...
            "search_term": self.state.job_search_params.get("search_term", "Software Developer"),
    ...
    def finalize_results(self):
        ...
        print(f"Skills analysis: Available in flow state")
...
def run_job_search_flow(user_profile: Dict[str, Any] = None, job_search_params: Dict[str, Any] = None):
    """
